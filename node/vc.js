...
x('http://txly2.net/vc', 'tbody tr', [{
    ...
    (function(err, results) {
        ...
        results.forEach(function(audio, arrayIndex) {
            ...
            //     fs.writeFileSync('../vc/' + fileName, data);
            // });
            audio.duration = 1760;
            audio.size = "14.1M";
            audio.artistId = 43;
            audio.artistName = "良院专区";
            audio.id = 43000001 + arrayIndex;

        });

        fs.writeFile("./vc.json", JSON.stringify(results, null, '\t'));
    });