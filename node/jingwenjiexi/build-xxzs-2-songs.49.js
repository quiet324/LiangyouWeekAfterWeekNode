...
for (var i = 1; i < 10; i++) {
    ...
    audio.path = "http://media.haomuren.org/Message/BibleTeaching/090215PMin02-0" + i + ".mp3";

    audio.id = 4055 * 1000000 + i;
    audio.albumId = 4055;
    audio.albumName = "小先知书系列(二)";
    audio.albumtitle = "小先知书系列(二)" + "(" + (i) + ")";
...
fs.writeFile("./xxzs_2_songs.json", JSON.stringify(audios, null, '\t'));
