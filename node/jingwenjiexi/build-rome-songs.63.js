...
for (var i = 1; i <= 12; i++) {
    ...
    if (i < 5) {
        audio.path = "http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/06120" + (6 + i - 1) + "PL.mp3";

    } else {
        audio.path = "http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/0612" + (6 + i - 1) + "PL.mp3";

    }
    audio.id = 4106 * 1000000 + i;
    audio.albumId = 4106;
    audio.albumName = "罗马书系列";
    audio.albumtitle = "罗马书系列" + "(" + (i) + ")";
...
fs.writeFile("./rome_songs.json", JSON.stringify(audios, null, '\t'));
