...
// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/070410P.mp3

// http://media.haomuren.org/message/BibleTeaching/2014Eph01-12.mp3
// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/060530LP.mp3
// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/060519LP.mp3

// http://media.haomuren.org/Message/BibleTeaching/2015Col01-10.mp3
// http://media.haomuren.org/Message/BibleTeaching/2015Col02-11.mp3

// http://media.haomuren.org/Message/BibleTeaching/090128P1Tim01-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2015Tit01-10.mp3
// http://media.haomuren.org/Message/BibleTeaching/2015Tit02-09.mp3
// http://media.haomuren.org/Message/BibleTeaching/100403PHe01-14.mp3
// http://media.haomuren.org/Message/BibleTeaching/110406PHeb02-18.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016Jm01-05.mp3

// http://media.haomuren.org/message/bibleteaching/2013Pe01-10.mp3

// http://media.haomuren.org/message/bibleteaching/2013Pe02-10.mp3

// http://media.haomuren.org/message/bibleteaching/2013Pe03-10.mp3

// http://media.haomuren.org/message/bibleteaching/2013EpJn01-12.mp3

// http://media.haomuren.org/message/bibleteaching/2013EpJn02-12.mp3

// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/070316P.mp3

// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/060901PL.mp3

// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/061030LP.mp3

// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/060620CL.mp3
// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/060531LP.mp3
// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/060601CL.mp3

// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/060724L.mp3

// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/060805PC.mp3
// http: //www.w4j.org/m/HaoMuRen/Upload/NewsAttach/060725L.mp3

// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/061002C.mp3
// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/060921C.mp3

// http://www.haomuren.org/Upload/NewsAttach/071024T.mp3
var audios = [];
...
for (var i = 1; i <= 10; i++) {
    ...
    audio.path = "http://www.haomuren.org/Upload/NewsAttach/0710" + (15 + i - 1) + "T.mp3";


    // if (i < 11) {
    //     audio.path = "http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/0609" + (21 + i - 1) + "C.mp3";

    // } else {
    //     audio.path = "http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/06100" + (i - 10) + "C.mp3";
    ...
    // if (i < 2) {
    //     audio.path = "http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/0605" + (31 + i - 1) + "LP.mp3";

    // } else if (i < 11) {
    //     audio.path = "http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/06060" + (i - 1) + "CL.mp3";

    // } else {
    //     audio.path = "http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/0606" + (i - 1) + "CL.mp3";
    ...
    // if (i < 10) {
    //     audio.path = "http://media.haomuren.org/message/bibleteaching/2013EpJn02-0" + i + ".mp3";

    // } else {
    //     audio.path = "http://media.haomuren.org/message/bibleteaching/2013EpJn02-" + i + ".mp3";

    // }

    audio.id = 4157 * 1000000 + i;
    audio.albumId = 4157;
    audio.albumName = "教会概论";
    audio.albumtitle = "教会概论" + "(" + (i) + ")";
...
fs.writeFile("./church_summary_songs.json", JSON.stringify(audios, null, '\t'));
