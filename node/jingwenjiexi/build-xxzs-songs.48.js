...
for (var i = 1; i < 23; i++) {
    ...
    audio.path = "http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/0706" + (16 + i - 1) + "P.mp3";

    audio.id = 4054 * 1000000 + i;
    audio.albumId = 4054;
    audio.albumName = "小先知书系列(一)";
    audio.albumtitle = "小先知书系列(一)" + "(" + (i) + ")";
...
fs.writeFile("./xxzs_songs.json", JSON.stringify(audios, null, '\t'));
