...
// http://media.haomuren.org/message/BibleTeaching/2014Eph02-12.mp3
// http://media.haomuren.org/message/BibleTeaching/2014Eph03-12.mp3
// http://media.haomuren.org/message/BibleTeaching/2014Eph04-12.mp3
// http://media.haomuren.org/message/BibleTeaching/2014Eph05-12.mp3
// http://media.haomuren.org/message/BibleTeaching/2014Eph06-16.mp3
// http://media.haomuren.org/Message/BibleTeaching/2017eph01-09.mp3
// http://media.haomuren.org/Message/BibleTeaching/2017eph02-09.mp3
// http://media.haomuren.org/Message/BibleTeaching/2017eph03-04.mp3
var audios = [];
...
for (var i = 1; i <= 4; i++) {
    ...
    if (i < 10) {
        audio.path = "http://media.haomuren.org/Message/BibleTeaching/2017eph03-0" + i + ".mp3";

    } else {
        audio.path = "http://media.haomuren.org/Message/BibleTeaching/2017eph03-" + i + ".mp3";

    }
    audio.id = 4135 * 1000000 + i;
    audio.albumId = 4135;
    audio.albumName = "以弗所书系列三";
    audio.albumtitle = "以弗所书系列三" + "(" + (i) + ")";
...
fs.writeFile("./yfss_10_songs.json", JSON.stringify(audios, null, '\t'));
