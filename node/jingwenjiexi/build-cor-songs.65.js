...
// http://www.haomuren.org/Upload/NewsAttach/070928P.mp3
// http://www.haomuren.org/Upload/NewsAttach/070830P.mp3

// http://media.haomuren.org/Message/BibleTeaching/080718Pmiracle0-13.mp3
// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/100825PJn01-15.mp3
// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/100821PJn01-14.mp3
// http://media.haomuren.org/message/bibleteaching/10Jn02-16.mp3
// http://media.haomuren.org/message/bibleteaching/10Jn02-01.mp3

// http://media.haomuren.org/Message/BibleTeaching/2011JohnIII-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2011JohnIII-01.mp3

// http://media.haomuren.org/Message/BibleTeaching/2011John4-14.mp3
// http://media.haomuren.org/Message/BibleTeaching/2011John4-01.mp3

// http://media.haomuren.org/Message/BibleTeaching/2011John5-14.mp3
// http://media.haomuren.org/Message/BibleTeaching/2011John5-01.mp3

// http://media.haomuren.org/Message/BibleTeaching/2011John6-15.mp3
// http://media.haomuren.org/Message/BibleTeaching/2011John6-01.mp3

// http://media.haomuren.org/Message/BibleTeaching/2012John7-14.mp3
// http://media.haomuren.org/Message/BibleTeaching/2012John7-01.mp3

// http://media.haomuren.org/Message/BibleTeaching/2016Jn01-10.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016Jn01-01.mp3

// http://media.haomuren.org/Message/BibleTeaching/2016Jn02-10.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016Jn02-01.mp3

// http://media.haomuren.org/Message/BibleTeaching/2016Jn03-10.mp3

// http://media.haomuren.org/Message/BibleTeaching/2016Jn04-10.mp3

// http://media.haomuren.org/Message/BibleTeaching/2016Jn05-11.mp3

// http://media.haomuren.org/Message/BibleTeaching/2016Jn06-11.mp3

// http://media.haomuren.org/Message/BibleTeaching/2015JsLf01-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2015JsLf02-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2015JsLf03-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2015JsLf04-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016JsLf05-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016JsLf06-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016JsLf07-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016JsLf08-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016JsLf09-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016JsLf10-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016JsLf11-12.mp3

// http://media.haomuren.org/Message/BibleTeaching/080229Pacts0-22.mp3

// http://media.haomuren.org/Message/BibleTeaching/110828PAc01-15.mp3
// http://media.haomuren.org/Message/BibleTeaching/2011Acts2-16.mp3

// http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/061217PL.mp3

// http://media.haomuren.org/Message/BibleTeaching/2015Romans01-10.mp3

// http://media.haomuren.org/Message/BibleTeaching/2015Romans02-10.mp3
// http://media.haomuren.org/Message/BibleTeaching/2015Romans03-10.mp3
// http://media.haomuren.org/Message/BibleTeaching/2015Romans04-12.mp3
// http://media.haomuren.org/Message/BibleTeaching/2016Romans05-12.mp3

// http://media.haomuren.org/Message/BibleTeaching/080622PICor0-15.mp3
// 
// http://media.haomuren.org/message/BibleTeaching/20141Co01-12.mp3

// http://media.haomuren.org/message/BibleTeaching/20141Co02-12.mp3

// http://media.haomuren.org/message/BibleTeaching/20141Co03-12.mp3

// http://media.haomuren.org/message/BibleTeaching/20141Co04-12.mp3

// http://media.haomuren.org/message/BibleTeaching/20141Co05-12.mp3

// http://media.haomuren.org/message/BibleTeaching/20141Co06-12.mp3

// http://media.haomuren.org/Message/BibleTeaching/2015ICo07-12.mp3

// http://media.haomuren.org/Message/BibleTeaching/2015ICo08-12.mp3

// http://media.haomuren.org/Message/BibleTeaching/2015ICo09-12.mp3

// http://media.haomuren.org/Message/BibleTeaching/2015ICo10-12.mp3

// http://media.haomuren.org/Message/BibleTeaching/090822P2Co01-09.mp3

// http://media.haomuren.org/Message/BibleTeaching/2015Gal1-10.mp3
// http://media.haomuren.org/Message/BibleTeaching/2015Gal2-12.mp3
var audios = [];
...
for (var i = 1; i <= 12; i++) {
    ...
    if (i < 10) {
        audio.path = "http://media.haomuren.org/Message/BibleTeaching/2015Gal2-0" + i + ".mp3";

    } else {
        audio.path = "http://media.haomuren.org/Message/BibleTeaching/2015Gal2-" + i + ".mp3";

    }
    audio.id = 4125 * 1000000 + i;
    audio.albumId = 4125;
    audio.albumName = "加拉太书系列(二)";
    audio.albumtitle = "加拉太书系列(二)" + "(" + (i) + ")";
...
fs.writeFile("./gal_2_songs.json", JSON.stringify(audios, null, '\t'));
