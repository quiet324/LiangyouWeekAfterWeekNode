...
for (var i = 1; i <= 12; i++) {
    ...
    audio.path = "http://www.w4j.org/m/HaoMuRen/Upload/NewsAttach/0605" + (19 + i - 1) + "LP.mp3";


    audio.id = 4136 * 1000000 + i;
    audio.albumId = 4136;
    audio.albumName = "腓立比书";
    audio.albumtitle = "腓立比书" + "(" + (i) + ")";
...
fs.writeFile("./flbs_songs.json", JSON.stringify(audios, null, '\t'));
