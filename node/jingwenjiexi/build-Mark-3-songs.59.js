...
for (var i = 1; i < 23; i++) {
    ...
    if (i < 10) {
        audio.path = "http://media.haomuren.org/Message/BibleTeaching/090506PMK05-0" + i + ".mp3";

    } else {
        audio.path = "http://media.haomuren.org/Message/BibleTeaching/090506PMK05-" + i + ".mp3";

    }
    audio.id = 4070 * 1000000 + i;
    audio.albumId = 4070;
    audio.albumName = "马可福音(五)";
    audio.albumtitle = "马可福音(五)" + "(" + (i) + ")";
...
fs.writeFile("./mark_5_songs.json", JSON.stringify(audios, null, '\t'));
