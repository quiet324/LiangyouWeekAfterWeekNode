...
x('http://txly2.net/tu', 'tbody tr', [{
    ...
    (function(err, results) {
        ...
        results.forEach(function(audio, arrayIndex) {
            ...
            //     fs.writeFileSync('../tu/' + fileName, data);
            // });
            audio.duration = 860;
            audio.size = "6.9M";
            audio.artistId = 33;
            audio.artistName = "信仰百宝箱";
            audio.id = 33000001 + arrayIndex;

        });

        fs.writeFile("./tu.json", JSON.stringify(results, null, '\t'));
    });