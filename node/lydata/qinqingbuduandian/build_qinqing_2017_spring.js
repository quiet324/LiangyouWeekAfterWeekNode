...
var datesEnglish = ["2017/01/02"];
results.forEach(function(id) {
    var day = moment(datesEnglish.slice(-1)[0]).add(id, 'days').format("YYYY/MM/DD");
    datesEnglish.push(day);
});
var datesEnglish = datesEnglish.filter(function(e) { return e !== '2017/01/30'; });
var datesEnglish = datesEnglish.filter(function(e) { return e !== '2017/02/02'; });


var datesEnglish2 = ["20170102"];
results.forEach(function(id) {
    var day = moment(datesEnglish2.slice(-1)[0]).add(id, 'days').format("YYYYMMDD");
    datesEnglish2.push(day);
});

var datesEnglish2 = datesEnglish2.filter(function(e) { return e !== '20170130'; });
var datesEnglish2 = datesEnglish2.filter(function(e) { return e !== '20170202'; });
...
datesEnglish.forEach(function(date, indexId) {
    ...
    x(realUrl, '.entry-post p', [{
        ...
        (function(err, hrefs) {
            ...
            audio.duration = 1760;
            audio.size = "14.1M";
            audio.albumName = "亲情不断电 " + year + "年春季合集";
            audio.id = 6263 * 1000000 + i;
            audio.albumId = 6263;
            audio.albumtitle = "亲情不断电 " + year + "年春季合集" + "(" + (indexId + 1) + ")";
    ...
    fs.writeFile("qinqing_" + year + "_spring.json", JSON.stringify(audios, null, '\t'));
});