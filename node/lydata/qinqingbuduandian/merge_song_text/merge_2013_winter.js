...
var qinqing_2013_summer = JSON.parse(fs.readFileSync('./' + 'qinqing_2013_winter_2' + '.json', 'utf8'));
var up_2013_summer = JSON.parse(fs.readFileSync('./' + 'up_2013_winter_2' + '.json', 'utf8'));


up_2013_summer.forEach(function(file, index) {

    if (file.textContent.length < 100) {
        file.textContent = qinqing_2013_summer[index].textContent;
    }

});

fs.writeFileSync('./' + 'up_2013_winter_2' + '.json', JSON.stringify(up_2013_summer, null, '\t'));
