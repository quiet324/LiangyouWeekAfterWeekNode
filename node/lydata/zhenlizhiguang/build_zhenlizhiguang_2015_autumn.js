...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6221 * 1000000 + indexId + 1;
    audio.albumId = 6221;
    audio.albumName = "《真理之光》2015年秋季合集";
    audio.albumtitle = "《真理之光》2015年秋季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./th2015_autumn_songs.json", JSON.stringify(audios, null, '\t'));