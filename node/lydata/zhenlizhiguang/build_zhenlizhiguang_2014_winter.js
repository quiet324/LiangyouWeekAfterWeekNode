...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6218 * 1000000 + indexId + 1;
    audio.albumId = 6218;
    audio.albumName = "《真理之光》2014年冬季合集";
    audio.albumtitle = "《真理之光》2014年冬季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./th2014_winter_songs.json", JSON.stringify(audios, null, '\t'));