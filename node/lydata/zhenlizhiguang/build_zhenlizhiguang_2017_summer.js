...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6228 * 1000000 + indexId + 1;
    audio.albumId = 6228;
    audio.albumName = "《真理之光》2017年夏季合集";
    audio.albumtitle = "《真理之光》2017年夏季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./th2017_summer_songs.json", JSON.stringify(audios, null, '\t'));