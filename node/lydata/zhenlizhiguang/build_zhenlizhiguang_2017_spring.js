...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6227 * 1000000 + indexId + 1;
    audio.albumId = 6227;
    audio.albumName = "《真理之光》2017年春季合集";
    audio.albumtitle = "《真理之光》2017年春季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./th2017_spring_songs.json", JSON.stringify(audios, null, '\t'));