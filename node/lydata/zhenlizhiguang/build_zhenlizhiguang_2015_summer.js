...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6220 * 1000000 + indexId + 1;
    audio.albumId = 6220;
    audio.albumName = "《真理之光》2015年夏季合集";
    audio.albumtitle = "《真理之光》2015年夏季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./th2015_summer_songs.json", JSON.stringify(audios, null, '\t'));