...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6223 * 1000000 + indexId + 1;
    audio.albumId = 6223;
    audio.albumName = "《真理之光》2016年春季合集";
    audio.albumtitle = "《真理之光》2016年春季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./th2016_spring_songs.json", JSON.stringify(audios, null, '\t'));