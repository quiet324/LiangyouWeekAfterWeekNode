...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6225 * 1000000 + indexId + 1;
    audio.albumId = 6225;
    audio.albumName = "《真理之光》2016年秋季合集";
    audio.albumtitle = "《真理之光》2016年秋季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./th2016_autumn_songs.json", JSON.stringify(audios, null, '\t'));