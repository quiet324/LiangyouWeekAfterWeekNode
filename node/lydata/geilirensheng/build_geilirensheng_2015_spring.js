...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6264 * 1000000 + indexId + 1;
    audio.albumId = 6264;
    audio.albumName = "《给力人生》2015年春季合集";
    audio.albumtitle = "《给力人生》2015年春季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./sr2015_spring_songs.json", JSON.stringify(audios, null, '\t'));