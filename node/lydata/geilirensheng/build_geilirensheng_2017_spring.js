...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6272 * 1000000 + indexId + 1;
    audio.albumId = 6272;
    audio.albumName = "《给力人生》2017年春季合集";
    audio.albumtitle = "《给力人生》2017年春季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./sr2017_spring_songs.json", JSON.stringify(audios, null, '\t'));