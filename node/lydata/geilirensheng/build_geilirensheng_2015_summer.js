...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6265 * 1000000 + indexId + 1;
    audio.albumId = 6265;
    audio.albumName = "《给力人生》2015年夏季合集";
    audio.albumtitle = "《给力人生》2015年夏季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./sr2015_summer_songs.json", JSON.stringify(audios, null, '\t'));