...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6263 * 1000000 + indexId + 1;
    audio.albumId = 6263;
    audio.albumName = "《给力人生》2014年冬季合集";
    audio.albumtitle = "《给力人生》2014年冬季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./sr2014_winter_songs.json", JSON.stringify(audios, null, '\t'));