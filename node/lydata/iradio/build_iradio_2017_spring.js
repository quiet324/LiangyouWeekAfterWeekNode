...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6245 * 1000000 + indexId + 1;
    audio.albumId = 6245;
    audio.albumName = "《i-Radio爱广播》2017年春季合集";
    audio.albumtitle = "《i-Radio爱广播》2017年春季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./ir2017_spring_songs.json", JSON.stringify(audios, null, '\t'));