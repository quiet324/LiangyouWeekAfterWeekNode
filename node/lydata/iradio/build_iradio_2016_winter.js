...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6244 * 1000000 + indexId + 1;
    audio.albumId = 6244;
    audio.albumName = "《i-Radio爱广播》2016年冬季合集";
    audio.albumtitle = "《i-Radio爱广播》2016年冬季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./ir2016_winter_songs.json", JSON.stringify(audios, null, '\t'));