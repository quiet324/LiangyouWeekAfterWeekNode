...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6243 * 1000000 + indexId + 1;
    audio.albumId = 6243;
    audio.albumName = "《i-Radio爱广播》2016年秋季合集";
    audio.albumtitle = "《i-Radio爱广播》2016年秋季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./ir2016_autumn_songs.json", JSON.stringify(audios, null, '\t'));