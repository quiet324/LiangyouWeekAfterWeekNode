...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6246 * 1000000 + indexId + 1;
    audio.albumId = 6246;
    audio.albumName = "《i-Radio爱广播》2017年夏季合集";
    audio.albumtitle = "《i-Radio爱广播》2017年夏季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./ir2017_summer_songs.json", JSON.stringify(audios, null, '\t'));