...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6234 * 1000000 + indexId + 1;
    audio.albumId = 6234;
    audio.albumName = "《信仰百宝箱》2017年上半年合集";
    audio.albumtitle = "《信仰百宝箱》2017年上半年合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./tu2017_spring_songs.json", JSON.stringify(audios, null, '\t'));