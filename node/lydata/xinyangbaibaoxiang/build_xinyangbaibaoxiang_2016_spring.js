...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6232 * 1000000 + indexId + 1;
    audio.albumId = 6232;
    audio.albumName = "《信仰百宝箱》2016年上半年合集";
    audio.albumtitle = "《信仰百宝箱》2016年上半年合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./tu2016_spring_songs.json", JSON.stringify(audios, null, '\t'));