...
dates.forEach(function(date, indexId) {
    ...
    audio.id = 6233 * 1000000 + indexId + 1;
    audio.albumId = 6233;
    audio.albumName = "《信仰百宝箱》2016年下半年合集";
    audio.albumtitle = "《信仰百宝箱》2016年下半年合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./tu2016_autumn_songs.json", JSON.stringify(audios, null, '\t'));