...
const url = 'http://lydata.febcmedia.net/2015/10/01/?arcf=cat:154';
...
for (var i = 1; i <= 24; i++) {
    ...
    if (i <= 9) {
        var realUrl = 'http://lydata.febcmedia.net/2015/10/0' + i + '/?arcf=cat:154';
    } else if (i <= 31) {
        var realUrl = 'http://lydata.febcmedia.net/2015/10/' + i + '/?arcf=cat:154';
    } else if (i <= 40) {
    ...
    x(realUrl, '.entry-post p', [{
        ...
        (function(err, hrefs) {
            ...
            if (i <= 9) {
                ...
                audio.path = 'http://media.febcchinese.org/streaming/bv/bv15100' + i + '.mp3';
            } else if (i <= 31) {
                audio.title = hrefs[0].content + ' 201510' + i;
                audio.path = 'http://media.febcchinese.org/streaming/bv/bv1510' + i + '.mp3';
            } else if (i <= 40) {
            ...
            audio.duration = 1760;
            audio.size = "14.1M";
            audio.albumName = "灵命日粮 2015年冬季合集";
            audio.id = 6211 * 1000000 + i;
            audio.albumId = 6211;
            audio.albumtitle = "灵命日粮 2015年冬季合集" + "(" + i + ")";
    ...
    fs.writeFile("kuangyemana_2015_winter.json", JSON.stringify(audios, null, '\t'));
}