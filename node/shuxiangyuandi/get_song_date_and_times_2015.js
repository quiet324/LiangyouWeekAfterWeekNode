...
var dates = ["20150101", "20150102", "20150105"];
results.forEach(function(id) {
    var day = moment(dates.slice(-1)[0]).add(id, 'days').format("YYYYMMDD");
    dates.push(day);
});

var dates = dates.filter(function(e) { return e !== '20150105'; });
...
var names = JSON.parse(fs.readFileSync('./bc2015_names.json', 'utf8'));
...
fs.writeFile("./bc2015_names_with_dates.json", JSON.stringify(name_and_dates, null, '\t'));
