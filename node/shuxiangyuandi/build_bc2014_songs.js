...
var names = JSON.parse(fs.readFileSync('./bc2014_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 1760;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceBC2014/170712/bc2014" + '/' + name.name;
    audio.id = 5006 * 1000000 + indexId + 1;
    audio.albumId = 5006;
    audio.albumName = "《书香园地》2014 年合集";
    audio.albumtitle = "《书香园地》2014 年合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./bc2014_songs.json", JSON.stringify(audios, null, '\t'));
