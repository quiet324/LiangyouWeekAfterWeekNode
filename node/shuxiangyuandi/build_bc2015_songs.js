...
var names = JSON.parse(fs.readFileSync('./bc2015_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 1760;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceBC2015/170713/bc2015" + '/' + name.name;
    audio.id = 5007 * 1000000 + indexId + 1;
    audio.albumId = 5007;
    audio.albumName = "《书香园地》2015 年合集";
    audio.albumtitle = "《书香园地》2015 年合集" + "(" + (indexId + 1) + ")";
    audio.title = "书香园地-" + name.date;
...
fs.writeFile("./bc2015_songs.json", JSON.stringify(audios, null, '\t'));
