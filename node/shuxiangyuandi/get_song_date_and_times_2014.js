...
var dates = ["20140114", "20140115", "20140116", "20140117", "20140120"];
...
var dates = dates.filter(function(e) { return e !== '20140211'; });

// var dates = dates.filter(function(e) { return e !== '20150424'; });
...
var names = JSON.parse(fs.readFileSync('./bc2014_names.json', 'utf8'));
...
fs.writeFile("./bc2014_names_with_dates.json", JSON.stringify(name_and_dates, null, '\t'));
