...
var names = JSON.parse(fs.readFileSync('./bc2016_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 1760;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceBC2016/170713/bc2016" + '/' + name.name;
    audio.id = 5008 * 1000000 + indexId + 1;
    audio.albumId = 5008;
    audio.albumName = "《书香园地》2016 年合集";
    audio.albumtitle = "《书香园地》2016 年合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./bc2016_songs.json", JSON.stringify(audios, null, '\t'));
