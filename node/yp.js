...
x('http://txly2.net/yp', 'tbody tr', [{
    ...
    (function(err, results) {
        ...
        results.forEach(function(audio, arrayIndex) {
            ...
            //     fs.writeFileSync('../yp/' + fileName, data);
            // });
            audio.duration = 1760;
            audio.size = "14.1M";
            audio.artistId = 39;
            audio.artistName = "善牧良言";
            audio.id = 39000001 + arrayIndex;

        });

        fs.writeFile("./yp.json", JSON.stringify(results, null, '\t'));
    });