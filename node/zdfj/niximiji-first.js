...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=176&Pid=16&Version=0&Charset=gb2312&page=0';

// var results = JSON.parse(fs.readFileSync('./niximiji.json', 'utf8'));
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                titles.forEach(function(audio, arrayIndex) {
                    ...
                    audio.duration = 1500;
                    audio.size = "4.6M";
                    audio.albumName = "《真道分解》尼希米记";
                    audio.albumId = 415;
                    audio.id = 415888180 + arrayIndex;
                    // audio.id = _.last(results).id + 1 + arrayIndex;

                    audio.albumtitle = "《真道分解》尼希米记(" + (audio.id - 415888180 + 1) + ")";
                    audio.artistId = 36;
                ...
                fs.writeFile("./niximiji.json", JSON.stringify(titles, null, '\t'));
            });
