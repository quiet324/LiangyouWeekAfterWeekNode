...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=300&Pid=21&Version=0&Charset=gb2312&page=1';
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./shijingzhiyingshize.json", JSON.stringify(other, null, '\t'));
            });
