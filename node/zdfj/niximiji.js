...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=176&Pid=16&Version=0&Charset=gb2312&page=2';
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./niximiji.json", JSON.stringify(other, null, '\t'));
            });
