...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=169&Pid=16&Version=0&Charset=gb2312&page=3';
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./shishiji.json", JSON.stringify(other, null, '\t'));
            });
