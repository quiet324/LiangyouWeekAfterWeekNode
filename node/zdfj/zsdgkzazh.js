...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=308&Pid=21&Version=0&Charset=gb2312&page=1';
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./csdgkzazh.json", JSON.stringify(other, null, '\t'));
            });
