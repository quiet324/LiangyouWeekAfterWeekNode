...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=171&Pid=16&Version=0&Charset=gb2312&page=0';
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./shamoerjishang.json", JSON.stringify(titles, null, '\t'));
            });
