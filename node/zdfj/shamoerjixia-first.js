...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=172&Pid=16&Version=0&Charset=gb2312&page=0';

// var results = JSON.parse(fs.readFileSync('./shamoerjixia.json', 'utf8'));
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                titles.forEach(function(audio, arrayIndex) {
                    ...
                    audio.duration = 1760;
                    audio.size = "5M";
                    audio.albumName = "《真道分解》撒母耳记下";
                    audio.albumId = 410;
                    audio.id = 410888180 + arrayIndex;
                    // audio.id = _.last(results).id + 1 + arrayIndex;

                    audio.albumtitle = "《真道分解》撒母耳记下(" + (audio.id - 410888180 + 1) + ")";
                    audio.artistId = 36;
                ...
                fs.writeFile("./shamoerjixia.json", JSON.stringify(titles, null, '\t'));
            });
