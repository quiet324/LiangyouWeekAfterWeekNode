...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=226&Pid=17&Version=0&Charset=gb2312&page=0';
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./bideqianhoushu.json", JSON.stringify(titles, null, '\t'));
            });
