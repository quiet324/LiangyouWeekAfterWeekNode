...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=174&Pid=16&Version=0&Charset=gb2312&page=0';

// var results = JSON.parse(fs.readFileSync('./lidaijishang.json', 'utf8'));
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                titles.forEach(function(audio, arrayIndex) {
                    ...
                    audio.duration = 1200;
                    audio.size = "3.8M";
                    audio.albumName = "《真道分解》历代志上";
                    audio.albumId = 412;
                    audio.id = 412888180 + arrayIndex;
                    // audio.id = _.last(results).id + 1 + arrayIndex;

                    audio.albumtitle = "《真道分解》历代志上(" + (audio.id - 412888180 + 1) + ")";
                    audio.artistId = 36;
                ...
                fs.writeFile("./lidaijishang.json", JSON.stringify(titles, null, '\t'));
            });
