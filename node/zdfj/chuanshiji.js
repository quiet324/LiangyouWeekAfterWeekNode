...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=158&Pid=16&Version=0&Charset=gb2312&page=8';


var results = JSON.parse(fs.readFileSync('./chuanshiji.json', 'utf8'));
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                titles.forEach(function(audio, arrayIndex) {
                    ...
                    audio.duration = 1760;
                    audio.size = "4.8M";
                    audio.albumName = "《真道分解》创世记";
                    audio.albumId = 401;
                    // audio.id = 401888180 + arrayIndex;
                    audio.id = _.last(results).id + 1 + arrayIndex;


                    audio.albumtitle = "《真道分解》创世记(" + (audio.id - 401888180 + 1) + ")";
                    audio.artistId = 36;
                ...
                fs.writeFile("./chuanshiji.json", JSON.stringify(other, null, '\t'));
            });
