...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=170&Pid=16&Version=0&Charset=gb2312&page=0';

// var results = JSON.parse(fs.readFileSync('./ludeji.json', 'utf8'));
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                titles.forEach(function(audio, arrayIndex) {
                    ...
                    audio.duration = 920;
                    audio.size = "3M";
                    audio.albumName = "《真道分解》路得记";
                    audio.albumId = 408;
                    audio.id = 408888180 + arrayIndex;
                    // audio.id = _.last(results).id + 1 + arrayIndex;

                    audio.albumtitle = "《真道分解》路得记(" + (audio.id - 408888180 + 1) + ")";
                    audio.artistId = 36;
                ...
                fs.writeFile("./ludeji.json", JSON.stringify(titles, null, '\t'));
            });
