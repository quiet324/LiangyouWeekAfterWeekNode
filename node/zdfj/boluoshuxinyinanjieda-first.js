...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=318&Pid=21&Version=0&Charset=gb2312&page=0';
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./baoluoshuxinyinanjieda.json", JSON.stringify(titles, null, '\t'));
            });
