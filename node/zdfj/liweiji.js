...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=166&Pid=16&Version=0&Charset=gb2312&page=2';


var results = JSON.parse(fs.readFileSync('./liweiji.json', 'utf8'));
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./liweiji.json", JSON.stringify(other, null, '\t'));
            });
