...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=168&Pid=16&Version=0&Charset=gb2312&page=0';

// var results = JSON.parse(fs.readFileSync('./shengmingji.json', 'utf8'));
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                titles.forEach(function(audio, arrayIndex) {
                    ...
                    audio.duration = 1760;
                    audio.size = "4.8M";
                    audio.albumName = "《真道分解》申命记";
                    audio.albumId = 405;
                    audio.id = 405888180 + arrayIndex;
                    // audio.id = _.last(results).id + 1 + arrayIndex;

                    audio.albumtitle = "《真道分解》申命记(" + (audio.id - 405888180 + 1) + ")";
                    audio.artistId = 36;
                ...
                fs.writeFile("./shengmingji.json", JSON.stringify(titles, null, '\t'));
            });
