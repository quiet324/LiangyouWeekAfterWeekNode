...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=206&Pid=17&Version=0&Charset=gb2312&page=2';
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./lujiafuyin.json", JSON.stringify(other, null, '\t'));
            });
