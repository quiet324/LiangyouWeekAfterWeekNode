...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=163&Pid=16&Version=0&Charset=gb2312&page=3';


var results = JSON.parse(fs.readFileSync('./cajj.json', 'utf8'));
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                titles.forEach(function(audio, arrayIndex) {
                    ...
                    audio.duration = 1760;
                    audio.size = "4.8M";
                    audio.albumName = "《真道分解》出埃及记";
                    audio.albumId = 402;
                    // audio.id = 401888180 + arrayIndex;
                    audio.id = _.last(results).id + 1 + arrayIndex;


                    audio.albumtitle = "《真道分解》出埃及记(" + (audio.id - 402888180 + 1) + ")";
                    audio.artistId = 36;
                ...
                fs.writeFile("./cajj.json", JSON.stringify(other, null, '\t'));
            });
