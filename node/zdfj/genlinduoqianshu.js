...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=212&Pid=17&Version=0&Charset=gb2312&page=3';
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./genlinduoqianshu.json", JSON.stringify(other, null, '\t'));
            });
