...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=242&Pid=20&Version=0&Charset=gb2312&page=4';
    ...
    (function(err, hrefs) {
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                fs.writeFile("./shengjingcihui.json", JSON.stringify(other, null, '\t'));
            });
