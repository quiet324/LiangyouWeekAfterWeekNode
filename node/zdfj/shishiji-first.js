...
const url = 'http://www.lyzhendao.net/Common/Reader/Channel/ShowPage.jsp?Cid=169&Pid=16&Version=0&Charset=gb2312&page=0';

// var results = JSON.parse(fs.readFileSync('./shishiji.json', 'utf8'));
        ...
        x(url, 'div', [{
            ...
            (function(err, titles) {
                ...
                titles.forEach(function(audio, arrayIndex) {
                    ...
                    audio.duration = 890;
                    audio.size = "2.5M";
                    audio.albumName = "《真道分解》士师记";
                    audio.albumId = 407;
                    audio.id = 407888180 + arrayIndex;
                    // audio.id = _.last(results).id + 1 + arrayIndex;

                    audio.albumtitle = "《真道分解》士师记(" + (audio.id - 407888180 + 1) + ")";
                    audio.artistId = 36;
                ...
                fs.writeFile("./shishiji.json", JSON.stringify(titles, null, '\t'));
            });
