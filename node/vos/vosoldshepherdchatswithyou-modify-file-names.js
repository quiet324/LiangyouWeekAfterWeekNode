...
const files = _getAllFilesFromFolder(__dirname + "/vosoldshepherdchatswithyou");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/vosoldshepherdchatswithyou/" + file, __dirname + "/vosoldshepherdchatswithyou/" + 'vosoldshepherdchatswithyou0' + (arrayIndex + 1) + '.mp3', function(err) {
