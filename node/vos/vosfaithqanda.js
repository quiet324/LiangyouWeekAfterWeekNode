...
const files = _getAllFilesFromFolder(__dirname + "/vosfaithqanda");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/vosfaithqanda/" + file, __dirname + "/vosfaithqanda/" + 'vosfaithqanda0' + (arrayIndex + 1) + '.mp3', function(err) {
