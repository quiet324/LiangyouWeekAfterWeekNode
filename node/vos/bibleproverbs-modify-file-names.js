...
const files = _getAllFilesFromFolder(__dirname + "/bibleproverbs");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/bibleproverbs/" + file, __dirname + "/bibleproverbs/" + 'bibleproverbs0' + (arrayIndex + 1) + '.mp3', function(err) {
