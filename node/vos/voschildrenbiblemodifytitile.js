...
const files = _getAllFilesFromFolder(__dirname + "/voschildrenbible");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/voschildrenbible/" + file, __dirname + "/voschildrenbible/" + 'voschildrenbible0' + (arrayIndex + 101) + '.mp3', function(err) {
