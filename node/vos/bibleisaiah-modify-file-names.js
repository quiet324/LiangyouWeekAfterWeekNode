...
const files = _getAllFilesFromFolder(__dirname + "/bibleisaiah");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/bibleisaiah/" + file, __dirname + "/bibleisaiah/" + 'bibleisaiah0' + (arrayIndex + 1) + '.mp3', function(err) {
