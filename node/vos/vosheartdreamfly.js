...
const files = _getAllFilesFromFolder(__dirname + "/vosheartdreamfly");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/vosheartdreamfly/" + file, __dirname + "/vosheartdreamfly/" + 'vosheartdreamfly0' + (arrayIndex + 1) + '.mp3', function(err) {
