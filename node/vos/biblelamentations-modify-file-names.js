...
const files = _getAllFilesFromFolder(__dirname + "/biblelamentations");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/biblelamentations/" + file, __dirname + "/biblelamentations/" + 'biblelamentations0' + (arrayIndex + 1) + '.mp3', function(err) {
