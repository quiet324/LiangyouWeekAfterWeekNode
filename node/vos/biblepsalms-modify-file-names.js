...
const files = _getAllFilesFromFolder(__dirname + "/biblepsalms2");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/biblepsalms2/" + file, __dirname + "/biblepsalms2/" + 'biblepsalms0' + (arrayIndex + 100) + '.mp3', function(err) {
