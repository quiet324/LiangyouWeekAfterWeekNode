...
const files = _getAllFilesFromFolder(__dirname + "/voshappyaplan");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/voshappyaplan/" + file, __dirname + "/voshappyaplan/" + 'voshappyaplan0' + (arrayIndex + 1) + '.mp3', function(err) {
