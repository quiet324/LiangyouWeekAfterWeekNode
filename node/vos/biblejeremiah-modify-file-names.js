...
const files = _getAllFilesFromFolder(__dirname + "/biblejeremiah");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/biblejeremiah/" + file, __dirname + "/biblejeremiah/" + 'biblejeremiah0' + (arrayIndex + 1) + '.mp3', function(err) {
