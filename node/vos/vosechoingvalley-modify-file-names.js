...
const files = _getAllFilesFromFolder(__dirname + "/vosechoingvalley");
// console.log(files);
...
files.forEach(function(file, arrayIndex) {
    ...
    fs.rename(__dirname + "/vosechoingvalley/" + file, __dirname + "/vosechoingvalley/" + 'vosechoingvalley0' + (arrayIndex + 1) + '.mp3', function(err) {
