...
x('http://txly2.net/pb', 'tbody tr', [{
    ...
    (function(err, results) {
        ...
        results.forEach(function(audio, arrayIndex) {
            ...
            //     fs.writeFileSync('../pb/' + fileName, data);
            // });
            audio.duration = 1760;
            audio.size = "14.1M";
            audio.artistId = 44;
            audio.artistName = "接棒人";
            audio.id = 44000001 + arrayIndex;

        });

        fs.writeFile("./pb.json", JSON.stringify(results, null, '\t'));
    });