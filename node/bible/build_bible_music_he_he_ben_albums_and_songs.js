...
var results = JSON.parse(fs.readFileSync('./bible_xin_yi_ben_names_with_chapter_counts.json', 'utf8'));
var albums = JSON.parse(fs.readFileSync('./build_bible_music_he_he_ben_albums.json', 'utf8'));
    ...
    for (i = 1; i < bible.chapterCount + 1; i++) {
        ...
        if (fs.existsSync(file)) { //
            ...
            mp3Duration(file, function(err, duration) {
                ...
                audio.path = "https://rawcdn.githack.com/quiet324/BibleResourceLingTingBan/170708/" + bible.name.substring(2) + '/' + fileName;
...
fs.writeFileSync("./build_bible_music_he_he_ben_albums_and_songs.json", JSON.stringify(audios, null, '\t'));
