...
var songs = JSON.parse(fs.readFileSync('./bible_panshi_songs.json', 'utf8'));
var albums = JSON.parse(fs.readFileSync('./bible_panshi_albums.json', 'utf8'));
...
fs.writeFileSync("./bible_panshi_songs_with_chapterid.json", JSON.stringify(songs, null, '\t'));
