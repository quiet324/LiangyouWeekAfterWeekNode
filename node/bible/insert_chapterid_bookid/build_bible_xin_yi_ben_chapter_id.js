...
var songs = JSON.parse(fs.readFileSync('./bible_xin_yi_ben_songs.json', 'utf8'));
var albums = JSON.parse(fs.readFileSync('./bible_xin_yi_ben_albums.json', 'utf8'));
...
fs.writeFileSync("./bible_xin_yi_ben_songs_with_chapterid.json", JSON.stringify(songs, null, '\t'));
