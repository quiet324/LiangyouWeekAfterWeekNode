...
var songs = JSON.parse(fs.readFileSync('./bible_music_niv_songs.json', 'utf8'));
var albums = JSON.parse(fs.readFileSync('./bible_music_niv_albums.json', 'utf8'));
...
fs.writeFileSync("./bible_music_niv_songs_with_chapterid.json", JSON.stringify(songs, null, '\t'));
