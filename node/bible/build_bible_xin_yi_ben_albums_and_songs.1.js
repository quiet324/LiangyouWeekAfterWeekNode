...
var albums = JSON.parse(fs.readFileSync('./build_bible_xin_yi_ben_albums.json', 'utf8'));
    ...
    for (i = 1; i < bible.chapterCount + 1; i++) {
        ...
        if (fs.existsSync(file)) { //
            ...
            mp3Duration(file, function(err, duration) {
                ...
                audio.path = "https://rawcdn.githack.com/quiet324/BibleResourceXinYiBen/170706/" + bible.name + '/' + fileName;
...
fs.writeFileSync("./build_bible_xin_yi_ben_albums_and_songs.json", JSON.stringify(audios, null, '\t'));
