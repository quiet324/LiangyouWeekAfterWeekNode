...
results.forEach(function(bible, indexId) {
    ...
    album.duration = 500;
    album.size = "3M";
    album.id = 701 + indexId;
    album.name = "新译本-环球版 " + bible.name.substring(2);
    album.songCount = bible.chapterCount;
    album.albumCategoryId = 502;
    album.shortName = "";
...
fs.writeFileSync("./build_bible_xin_yi_ben_albums.json", JSON.stringify(albums, null, '\t'));