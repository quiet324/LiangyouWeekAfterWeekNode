...
results.forEach(function(bible, indexId) {
    ...
    album.duration = 500;
    album.size = "3M";
    album.id = 801 + indexId;
    album.name = "汉语和合本-音乐版  " + bible.name.substring(2);
    album.songCount = bible.chapterCount;
    album.albumCategoryId = 503;
    album.shortName = "";
...
fs.writeFileSync("./build_bible_music_he_he_ben_albums.json", JSON.stringify(albums, null, '\t'));