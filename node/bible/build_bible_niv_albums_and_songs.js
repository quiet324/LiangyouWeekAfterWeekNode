...
var results = JSON.parse(fs.readFileSync('./bible_niv_names_with_chapter_counts.json', 'utf8'));
var albums = JSON.parse(fs.readFileSync('./build_bible_niv_albums.json', 'utf8'));
...
fs.writeFileSync("./build_bible_niv_albums_and_songs.json", JSON.stringify(audios, null, '\t'));
