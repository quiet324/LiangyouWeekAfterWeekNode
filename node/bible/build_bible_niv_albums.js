...
results.forEach(function(bible, indexId) {
    ...
    album.duration = 500;
    album.size = "3M";
    album.id = 901 + indexId;
    album.name = "NIV英文-新国际 " + bible.name.substring(2);
    album.songCount = bible.chapterCount;
    album.albumCategoryId = 504;
    album.shortName = "";
...
fs.writeFileSync("./build_bible_niv_albums.json", JSON.stringify(albums, null, '\t'));