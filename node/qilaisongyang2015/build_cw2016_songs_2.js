...
var names = JSON.parse(fs.readFileSync('./cw2016_names_with_dates_2.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 860;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceCW2016/170708/cw2016" + '/' + name.name;
    audio.id = 5001 * 1000000 + 129 + indexId + 1;
    audio.albumId = 5001;
    audio.albumName = "《齐来颂扬》2016";
    audio.albumtitle = "《齐来颂扬》2016" + "(" + (129 + indexId + 1) + ")";
    audio.title = "齐来颂扬-" + name.date;
...
fs.writeFile("./cw2016_songs_2.json", JSON.stringify(audios, null, '\t'));
