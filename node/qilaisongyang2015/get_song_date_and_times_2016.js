...
var names = JSON.parse(fs.readFileSync('./cw2016_names.json', 'utf8'));
...
fs.writeFile("./cw2016_names_with_dates.json", JSON.stringify(name_and_dates, null, '\t'));
