...
var names = JSON.parse(fs.readFileSync('./cw2016_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 5001 * 1000000 + indexId + 1;
    audio.albumId = 5001;
    audio.albumName = "《齐来颂扬》2016";
    audio.albumtitle = "《齐来颂扬》2016" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./cw2016_songs.json", JSON.stringify(audios, null, '\t'));
