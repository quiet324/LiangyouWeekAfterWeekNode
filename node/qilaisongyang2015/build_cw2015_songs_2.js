...
var names = JSON.parse(fs.readFileSync('./cw2015_names_with_dates_2.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 860;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceCW2015/170708/cw2015" + '/' + name.name;
    audio.id = 5000 * 1000000 + 123 + indexId + 1;
    audio.albumId = 5000;
    audio.albumName = "《齐来颂扬》2015";
    audio.albumtitle = "《齐来颂扬》2015" + "(" + (123 + indexId + 1) + ")";
...
fs.writeFile("./cw2015_songs_2.json", JSON.stringify(audios, null, '\t'));
