...
var dates = dates.filter(function(e) { return e !== '20151123'; });
...
var names = JSON.parse(fs.readFileSync('./cw2015_names_2.json', 'utf8'));
...
fs.writeFile("./cw2015_names_with_dates_2.json", JSON.stringify(name_and_dates, null, '\t'));
