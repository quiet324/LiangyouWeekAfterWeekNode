...
var dates = dates.filter(function(e) { return e !== '20160912'; });
...
var names = JSON.parse(fs.readFileSync('./cw2016_names_2.json', 'utf8'));
...
fs.writeFile("./cw2016_names_with_dates_2.json", JSON.stringify(name_and_dates, null, '\t'));
