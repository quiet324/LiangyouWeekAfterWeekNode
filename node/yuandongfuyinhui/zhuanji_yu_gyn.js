...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=444';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1200;
            audio.size = "10M";
            audio.albumName = "【祝你健康】婦產科";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6055 * 1000000 + arrayIndex + 1;
            audio.albumId = 6055;
            audio.albumtitle = "【祝你健康】婦產科" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_yu_gyn.json", JSON.stringify(hrefs, null, '\t'));
