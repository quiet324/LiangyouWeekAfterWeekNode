...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=319';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1500;
            audio.size = "11.6M";
            audio.albumName = "復活節專題-王壽南";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6036 * 1000000 + arrayIndex + 1;
            audio.albumId = 6036;
            audio.albumtitle = "復活節專題-王壽南" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_fuhuojie.json", JSON.stringify(hrefs, null, '\t'));
