...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=224';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 2300;
            audio.size = "17.6M";
            audio.albumName = "活在希望中專題-王壽南";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6035 * 1000000 + arrayIndex + 1;
            audio.albumId = 6035;
            audio.albumtitle = "活在希望中專題-王壽南" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_hope.json", JSON.stringify(hrefs, null, '\t'));
