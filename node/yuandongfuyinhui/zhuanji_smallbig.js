...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=196';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1100;
            audio.size = "8.4M";
            audio.albumName = "小題大作-袁擇善、劉俠";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6046 * 1000000 + arrayIndex + 1;
            audio.albumId = 6046;
            audio.albumtitle = "小題大作-袁擇善、劉俠" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_smallbig.json", JSON.stringify(hrefs, null, '\t'));
