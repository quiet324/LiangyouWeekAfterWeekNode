...
const url = 'http://www.feearadio.net/official/contents2/bible?tid=23&gid=11&cid=280';
...
x(url, '#right .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 450;
            audio.size = "6.5M";
            audio.albumName = "【節目精選CD】2009年7月份 - 主愛中華。愛的探索";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6064 * 1000000 + arrayIndex + 1;
            audio.albumId = 6064;
            audio.albumtitle = "【節目精選CD】2009年7月份 - 主愛中華。愛的探索" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_cd_200907.json", JSON.stringify(hrefs, null, '\t'));
