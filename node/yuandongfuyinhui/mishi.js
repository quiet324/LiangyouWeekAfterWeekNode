...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=304';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.id = 6012 * 1000000 + arrayIndex + 1;
            audio.albumId = 6012;
            audio.albumtitle = "密室" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./mishi.json", JSON.stringify(hrefs, null, '\t'));
