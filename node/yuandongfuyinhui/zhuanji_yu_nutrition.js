...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=436';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 700;
            audio.size = "5.4M";
            audio.albumName = "【祝你健康】吃出健康營養力";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6049 * 1000000 + arrayIndex + 1;
            audio.albumId = 6049;
            audio.albumtitle = "【祝你健康】吃出健康營養力" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_yu_nutrition.json", JSON.stringify(hrefs, null, '\t'));
