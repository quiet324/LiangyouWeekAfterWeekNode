...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=205';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1800;
            audio.size = "13.7M";
            audio.albumName = "古典聖詩敎唱-范恩惠、洪頌恩";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6040 * 1000000 + arrayIndex + 1;
            audio.albumId = 6040;
            audio.albumtitle = "古典聖詩敎唱-范恩惠、洪頌恩" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_HolySongs_Fan.json", JSON.stringify(hrefs, null, '\t'));
