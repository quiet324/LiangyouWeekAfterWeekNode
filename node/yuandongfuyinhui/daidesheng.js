...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=19';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 600;
            audio.size = "5M";
            audio.albumName = "戴德生传";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6021 * 1000000 + arrayIndex + 1;
            audio.albumId = 6021;
            audio.albumtitle = "戴德生传" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./daidesheng.json", JSON.stringify(hrefs, null, '\t'));
