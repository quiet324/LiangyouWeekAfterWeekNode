...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=377';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 650;
            audio.size = "5M";
            audio.albumName = "标杆名人堂奥运特辑";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6029 * 1000000 + arrayIndex + 1;
            audio.albumId = 6029;
            audio.albumtitle = "标杆名人堂奥运特辑" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_olympic.json", JSON.stringify(hrefs, null, '\t'));
