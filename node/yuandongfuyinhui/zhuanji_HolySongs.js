...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=204';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1800;
            audio.size = "13.7M";
            audio.albumName = "聖樂中的合唱精華-陳麗芬";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6039 * 1000000 + arrayIndex + 1;
            audio.albumId = 6039;
            audio.albumtitle = "聖樂中的合唱精華-陳麗芬" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_HolySongs.json", JSON.stringify(hrefs, null, '\t'));
