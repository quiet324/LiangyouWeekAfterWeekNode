...
const url = 'http://www.feearadio.net/official/contents2/bible?tid=23&gid=11&cid=284';
...
x(url, '#right .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 500;
            audio.size = "3M";
            audio.albumName = "【節目精選CD】2009年3月份 - 主愛中華。愛的紀念";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6060 * 1000000 + arrayIndex + 1;
            audio.albumId = 6060;
            audio.albumtitle = "【節目精選CD】2009年3月份 - 主愛中華。愛的紀念" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_cd_200903.json", JSON.stringify(hrefs, null, '\t'));
