...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=452';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 600;
            audio.size = "5M";
            audio.albumName = "绝妙电影 - 阿甘";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6032 * 1000000 + arrayIndex + 1;
            audio.albumId = 6032;
            audio.albumtitle = "绝妙电影 - 阿甘" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_yu_movie.json", JSON.stringify(hrefs, null, '\t'));
