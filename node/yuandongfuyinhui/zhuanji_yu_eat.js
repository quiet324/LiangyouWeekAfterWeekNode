...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=424';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 700;
            audio.size = "26M";
            audio.albumName = "【祝你健康】食在安心";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6048 * 1000000 + arrayIndex + 1;
            audio.albumId = 6048;
            audio.albumtitle = "【祝你健康】食在安心" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_yu_eat.json", JSON.stringify(hrefs, null, '\t'));
