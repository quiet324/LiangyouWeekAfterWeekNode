...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=170';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 900;
            audio.size = "7M";
            audio.albumName = "登峰造極-袁擇善、陳恩惠";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6044 * 1000000 + arrayIndex + 1;
            audio.albumId = 6044;
            audio.albumtitle = "登峰造極-袁擇善、陳恩惠" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_dengfeng.json", JSON.stringify(hrefs, null, '\t'));
