...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=179';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1800;
            audio.size = "27.6M";
            audio.albumName = "快樂的泉源-江凡";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6045 * 1000000 + arrayIndex + 1;
            audio.albumId = 6045;
            audio.albumtitle = "快樂的泉源-江凡" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_Happy.json", JSON.stringify(hrefs, null, '\t'));
