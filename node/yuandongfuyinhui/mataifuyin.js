...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=321';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1500;
            audio.size = "11M";
            audio.albumName = "马太福音说书";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6010 * 1000000 + arrayIndex + 1;
            audio.albumId = 6010;
            audio.albumtitle = "马太福音说书" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./mataifuyin.json", JSON.stringify(hrefs, null, '\t'));
