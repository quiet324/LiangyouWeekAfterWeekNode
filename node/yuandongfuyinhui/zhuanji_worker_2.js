...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=455';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 900;
            audio.size = "7M";
            audio.albumName = "职场大公开：被赏识的方式 - 朱正中";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6027 * 1000000 + arrayIndex + 1;
            audio.albumId = 6027;
            audio.albumtitle = "职场大公开：被赏识的方式 - 朱正中" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_worker_2.json", JSON.stringify(hrefs, null, '\t'));
