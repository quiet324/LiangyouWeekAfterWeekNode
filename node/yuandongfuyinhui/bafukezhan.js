...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=17';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.albumId = 6004;
            audio.albumtitle = "八福客栈" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./bafukezhan.json", JSON.stringify(hrefs, null, '\t'));
