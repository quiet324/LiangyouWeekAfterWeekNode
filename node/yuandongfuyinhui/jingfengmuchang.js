...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=372';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 900;
            audio.size = "7M";
            audio.albumName = "為愛，希望升起-晶峰牧場上愛的奇蹟";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6015 * 1000000 + arrayIndex + 1;
            audio.albumId = 6015;
            audio.albumtitle = "為愛，希望升起-晶峰牧場上愛的奇蹟" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./jingfengmuchang.json", JSON.stringify(hrefs, null, '\t'));
