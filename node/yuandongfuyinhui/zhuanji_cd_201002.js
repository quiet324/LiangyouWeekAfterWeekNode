...
const url = 'http://www.feearadio.net/official/contents2/bible?tid=23&gid=11&cid=263';
...
x(url, '#right .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 550;
            audio.size = "4M";
            audio.albumName = "【節目精選CD】2010年2月份 - 可靠的嚮導。同行在愛中";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6071 * 1000000 + arrayIndex + 1;
            audio.albumId = 6071;
            audio.albumtitle = "【節目精選CD】2010年2月份 - 可靠的嚮導。同行在愛中" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_cd_201002.json", JSON.stringify(hrefs, null, '\t'));
