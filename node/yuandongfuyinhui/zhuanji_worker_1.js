...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=454';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1400;
            audio.size = "11M";
            audio.albumName = "活出自信的秘诀-朱正中";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6026 * 1000000 + arrayIndex + 1;
            audio.albumId = 6026;
            audio.albumtitle = "活出自信的秘诀-朱正中" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_worker_1.json", JSON.stringify(hrefs, null, '\t'));
