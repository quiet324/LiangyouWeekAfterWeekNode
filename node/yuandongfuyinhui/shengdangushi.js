...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=299';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 650;
            audio.size = "5M";
            audio.albumName = "圣诞故事";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6016 * 1000000 + arrayIndex + 1;
            audio.albumId = 6016;
            audio.albumtitle = "圣诞故事" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./shengdangushi.json", JSON.stringify(hrefs, null, '\t'));
