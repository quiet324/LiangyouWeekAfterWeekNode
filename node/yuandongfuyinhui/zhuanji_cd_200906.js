...
const url = 'http://www.feearadio.net/official/contents2/bible?tid=23&gid=11&cid=281';
...
x(url, '#right .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 450;
            audio.size = "6.5M";
            audio.albumName = "【節目精選CD】2009年6月份 - 主愛中華。愛的禮讚";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6063 * 1000000 + arrayIndex + 1;
            audio.albumId = 6063;
            audio.albumtitle = "【節目精選CD】2009年6月份 - 主愛中華。愛的禮讚" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_cd_200906.json", JSON.stringify(hrefs, null, '\t'));
