...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=437';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 700;
            audio.size = "5.4M";
            audio.albumName = "【祝你健康】自我保健暨老人與女性照護";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6050 * 1000000 + arrayIndex + 1;
            audio.albumId = 6050;
            audio.albumtitle = "【祝你健康】自我保健暨老人與女性照護" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_yu_selfcare.json", JSON.stringify(hrefs, null, '\t'));
