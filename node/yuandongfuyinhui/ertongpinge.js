...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=221';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 500;
            audio.size = "4M";
            audio.albumName = "儿童品格广播剧";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6024 * 1000000 + arrayIndex + 1;
            audio.albumId = 6024;
            audio.albumtitle = "儿童品格广播剧" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./ertongpinge.json", JSON.stringify(hrefs, null, '\t'));
