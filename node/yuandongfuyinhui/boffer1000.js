...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=370';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 900;
            audio.size = "7M";
            audio.albumName = "比一千頭水牛更有力--艾偉德宣教士的故事";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6013 * 1000000 + arrayIndex + 1;
            audio.albumId = 6013;
            audio.albumtitle = "比一千頭水牛更有力--艾偉德宣教士的故事" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./boffer1000.json", JSON.stringify(hrefs, null, '\t'));
