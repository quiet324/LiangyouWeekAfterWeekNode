...
const url = 'http://www.feearadio.net/official/contents2/bible?tid=23&gid=11&cid=282';
...
x(url, '#right .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 600;
            audio.size = "10M";
            audio.albumName = "【節目精選CD】2009年5月份 - 主愛中華。愛的教導";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6062 * 1000000 + arrayIndex + 1;
            audio.albumId = 6062;
            audio.albumtitle = "【節目精選CD】2009年5月份 - 主愛中華。愛的教導" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_cd_200905.json", JSON.stringify(hrefs, null, '\t'));
