...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=206';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1800;
            audio.size = "13.7M";
            audio.albumName = "聖樂古典賞析-孫自弘";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6041 * 1000000 + arrayIndex + 1;
            audio.albumId = 6041;
            audio.albumtitle = "聖樂古典賞析-孫自弘" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_HolySongs_Son.json", JSON.stringify(hrefs, null, '\t'));
