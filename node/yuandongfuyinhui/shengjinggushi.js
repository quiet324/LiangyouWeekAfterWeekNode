...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=181';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1200;
            audio.size = "20M";
            audio.albumName = "圣经故事广播剧";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6023 * 1000000 + arrayIndex + 1;
            audio.albumId = 6023;
            audio.albumtitle = "圣经故事广播剧" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./shengjinggushi.json", JSON.stringify(hrefs, null, '\t'));
