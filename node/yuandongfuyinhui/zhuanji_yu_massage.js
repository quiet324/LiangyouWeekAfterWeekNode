...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=447';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1200;
            audio.size = "10M";
            audio.albumName = "【祝你健康】推拿按摩";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6057 * 1000000 + arrayIndex + 1;
            audio.albumId = 6057;
            audio.albumtitle = "【祝你健康】推拿按摩" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_yu_massage.json", JSON.stringify(hrefs, null, '\t'));
