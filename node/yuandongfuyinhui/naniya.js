...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=14';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.id = 6018 * 1000000 + arrayIndex + 1;
            audio.albumId = 6018;
            audio.albumtitle = "纳尼亚" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./naniya.json", JSON.stringify(hrefs, null, '\t'));
