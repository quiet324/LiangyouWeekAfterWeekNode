...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=157';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 300;
            audio.size = "2.5M";
            audio.albumName = "絕妙啟示錄-張得仁";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6043 * 1000000 + arrayIndex + 1;
            audio.albumId = 6043;
            audio.albumtitle = "絕妙啟示錄-張得仁" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_unique.json", JSON.stringify(hrefs, null, '\t'));
