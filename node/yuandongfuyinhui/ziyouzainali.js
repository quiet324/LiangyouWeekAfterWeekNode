...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=151';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 900;
            audio.size = "7M";
            audio.albumName = "自由在哪里";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6017 * 1000000 + arrayIndex + 1;
            audio.albumId = 6017;
            audio.albumtitle = "自由在哪里" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./ziyouzainali.json", JSON.stringify(hrefs, null, '\t'));
