...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=168';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 600;
            audio.size = "5M";
            audio.albumName = "侠风长流";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6022 * 1000000 + arrayIndex + 1;
            audio.albumId = 6022;
            audio.albumtitle = "侠风长流" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./xiafengchangliu.json", JSON.stringify(hrefs, null, '\t'));
