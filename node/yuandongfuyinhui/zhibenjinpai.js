...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=16';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 600;
            audio.size = "5M";
            audio.albumName = "直奔金牌";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6020 * 1000000 + arrayIndex + 1;
            audio.albumId = 6020;
            audio.albumtitle = "直奔金牌" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhibenjinpai.json", JSON.stringify(hrefs, null, '\t'));
