...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=358';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1500;
            audio.size = "11M";
            audio.albumName = "光照系列-王壽南";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6038 * 1000000 + arrayIndex + 1;
            audio.albumId = 6038;
            audio.albumtitle = "光照系列-王壽南" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_light.json", JSON.stringify(hrefs, null, '\t'));
