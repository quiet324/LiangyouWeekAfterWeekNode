...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=18';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.albumId = 6003;
            audio.albumtitle = "天路历程" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./tianlulicheng.json", JSON.stringify(hrefs, null, '\t'));
