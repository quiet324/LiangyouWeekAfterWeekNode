...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=339';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 2300;
            audio.size = "17.6M";
            audio.albumName = "光明的人生系列-王壽南";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6037 * 1000000 + arrayIndex + 1;
            audio.albumId = 6037;
            audio.albumtitle = "光明的人生系列-王壽南" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_brifhtlife.json", JSON.stringify(hrefs, null, '\t'));
