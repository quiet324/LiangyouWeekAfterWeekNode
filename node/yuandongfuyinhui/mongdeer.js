...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=3&cid=371';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 900;
            audio.size = "7M";
            audio.albumName = "生命科學大師-遺傳學之父-孟德爾的故事";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6014 * 1000000 + arrayIndex + 1;
            audio.albumId = 6014;
            audio.albumtitle = "生命科學大師-遺傳學之父-孟德爾的故事" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./mongdeer.json", JSON.stringify(hrefs, null, '\t'));
