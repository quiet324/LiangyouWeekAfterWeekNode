...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=207';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1100;
            audio.size = "7.7M";
            audio.albumName = "兩性之間";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6047 * 1000000 + arrayIndex + 1;
            audio.albumId = 6047;
            audio.albumtitle = "兩性之間" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_manwoman.json", JSON.stringify(hrefs, null, '\t'));
