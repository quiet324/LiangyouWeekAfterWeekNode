...
const url = 'http://www.feearadio.net/official/mobile2/bible?tid=&gid=10&cid=296';
...
x(url, '.maincontent .files tr', [{
    ...
    (function(err, hrefs) {
        ...
        hrefs.forEach(function(audio, arrayIndex) {
            ...
            audio.duration = 1200;
            audio.size = "17M";
            audio.albumName = "從敬拜看詩班與指揮-李忠民";
            // audio.albumId = 6008;
            // audio.id = 6008888180 + arrayIndex;
            // audio.id = _.last(results).id + 1 + arrayIndex;

            audio.id = 6042 * 1000000 + arrayIndex + 1;
            audio.albumId = 6042;
            audio.albumtitle = "從敬拜看詩班與指揮-李忠民" + "(" + (arrayIndex + 1) + ")";
        ...
        fs.writeFile("./zhuanji_Choir.json", JSON.stringify(hrefs, null, '\t'));
