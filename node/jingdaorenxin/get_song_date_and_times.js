...
results.forEach(function(id) {
    var day = moment(dates.slice(-1)[0]).add(7, 'days').format("YYYYMMDD");
...
var names = JSON.parse(fs.readFileSync('./ba2015_names.json', 'utf8'));
...
fs.writeFile("./ba2015_names_with_dates.json", JSON.stringify(name_and_dates, null, '\t'));
