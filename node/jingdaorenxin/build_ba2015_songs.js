...
var names = JSON.parse(fs.readFileSync('./ba2015_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 1760;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceBA2016/170708/ba2015" + '/' + name.name;
    audio.id = 5002 * 1000000 + indexId + 1;
    audio.albumId = 5002;
    audio.albumName = "《经动人心》2015";
    audio.albumtitle = "《经动人心》2015" + "(" + (indexId + 1) + ")";
    audio.title = "经动人心-" + name.date;
...
fs.writeFile("./ba2015_songs.json", JSON.stringify(audios, null, '\t'));
