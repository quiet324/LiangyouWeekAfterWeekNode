...
var names = JSON.parse(fs.readFileSync('./tr2015_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 860;
    audio.size = "3.4M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceTR2015/170714/tr2015" + '/' + name.name;
    audio.id = 5011 * 1000000 + indexId + 1;
    audio.albumId = 5011;
    audio.albumName = "《彩虹桥》2015 年合集";
    audio.albumtitle = "《彩虹桥》2015 年合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./tr2015_songs.json", JSON.stringify(audios, null, '\t'));
