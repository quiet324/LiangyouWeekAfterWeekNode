...
var dates = dates.filter(function(e) { return e !== '20150325'; });

var dates = dates.filter(function(e) { return e !== '20150421'; });
...
var names = JSON.parse(fs.readFileSync('./tr2015_names.json', 'utf8'));
...
fs.writeFile("./tr2015_names_with_dates.json", JSON.stringify(name_and_dates, null, '\t'));
