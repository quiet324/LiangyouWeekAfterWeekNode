...
var names = JSON.parse(fs.readFileSync('./tr2016_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 860;
    audio.size = "3.4M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceTR2016/170714/tr2016" + '/' + name.name;
    audio.id = 5012 * 1000000 + indexId + 1;
    audio.albumId = 5012;
    audio.albumName = "《彩虹桥》2016 年合集";
    audio.albumtitle = "《彩虹桥》2016 年合集" + "(" + (indexId + 1) + ")";
    audio.title = "彩虹桥-" + name.date;
...
fs.writeFile("./tr2016_songs.json", JSON.stringify(audios, null, '\t'));
