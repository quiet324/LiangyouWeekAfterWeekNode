...
var names = JSON.parse(fs.readFileSync('./mw2016_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 1760;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceMW2016/170711/mw2016" + '/' + name.name;
    audio.id = 5005 * 1000000 + indexId + 1;
    audio.albumId = 5005;
    audio.albumName = "《旷野吗哪》2016";
    audio.albumtitle = "《旷野吗哪》2016" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./mw2016_songs.json", JSON.stringify(audios, null, '\t'));
