...
var dates = dates.filter(function(e) { return e !== '20160420'; });

var dates = dates.filter(function(e) { return e !== '20161113'; });

// var dates = dates.filter(function(e) { return e !== '20160911'; });
...
var names = JSON.parse(fs.readFileSync('./mw2016_names.json', 'utf8'));
...
fs.writeFile("./mw2016_names_with_dates.json", JSON.stringify(name_and_dates, null, '\t'));
