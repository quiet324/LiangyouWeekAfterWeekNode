...
var names = JSON.parse(fs.readFileSync('./albums_liangyouschool-missing.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    mkdirp.sync('liangyouschool-pdf-missing');

    fs.writeFileSync('liangyouschool-pdf-missing/' + fileName, data);
