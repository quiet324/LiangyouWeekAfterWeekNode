...
x('http://txly2.net/bs', 'tbody tr', [{
    ...
    (function(err, results) {
        ...
        results.forEach(function(audio, arrayIndex) {
            ...
            //     fs.writeFileSync('../bs/' + fileName, data);
            // });
            audio.duration = 1760;
            audio.size = "14.1M";
            audio.artistId = 38;
            audio.artistName = "圣言盛宴";
            audio.id = 38000001 + arrayIndex;

        });

        fs.writeFile("./bs.json", JSON.stringify(results, null, '\t'));
    });