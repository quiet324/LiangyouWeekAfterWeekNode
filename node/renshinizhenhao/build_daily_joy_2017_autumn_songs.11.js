...
var names = JSON.parse(fs.readFileSync('./daily_joy_2017_autumn_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6371 * 1000000 + indexId + 1;
    audio.albumId = 6371;
    audio.albumName = "《喜乐的心》秋季合集";
    audio.albumtitle = "《喜乐的心》秋季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_joy_2017_autumn_songs.json", JSON.stringify(audios, null, '\t'));
