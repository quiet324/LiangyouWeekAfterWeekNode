...
var names = JSON.parse(fs.readFileSync('./daily_joy_2017_winter_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6372 * 1000000 + indexId + 1;
    audio.albumId = 6372;
    audio.albumName = "《喜乐的心》冬季合集";
    audio.albumtitle = "《喜乐的心》冬季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_joy_2017_winter_songs.json", JSON.stringify(audios, null, '\t'));
