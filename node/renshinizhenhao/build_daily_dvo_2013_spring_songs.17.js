...
var names = JSON.parse(fs.readFileSync('./daily_dvo_2013_spring_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6377 * 1000000 + indexId + 1;
    audio.albumId = 6377;
    audio.albumName = "《荒漠甘泉乐侶》春季合集";
    audio.albumtitle = "《荒漠甘泉乐侶》春季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_dvo_2013_spring_songs.json", JSON.stringify(audios, null, '\t'));
