...
var names = JSON.parse(fs.readFileSync('./daily_day_by_day_Dvo_2014_summer_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6382 * 1000000 + indexId + 1;
    audio.albumId = 6382;
    audio.albumName = "《每日经历神》夏季合集";
    audio.albumtitle = "《每日经历神》夏季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_day_by_day_dvo_2014_summer_songs.json", JSON.stringify(audios, null, '\t'));
