...
var names = JSON.parse(fs.readFileSync('./daily_lv2017_spring_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6357 * 1000000 + indexId + 1;
    audio.albumId = 6357;
    audio.albumName = "《活水》春季合集";
    audio.albumtitle = "《活水》春季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_lv_2017_spring_songs.json", JSON.stringify(audios, null, '\t'));
