...
var names = JSON.parse(fs.readFileSync('./daily_dvo_2013_winter_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6380 * 1000000 + indexId + 1;
    audio.albumId = 6380;
    audio.albumName = "《荒漠甘泉乐侶》冬季合集";
    audio.albumtitle = "《荒漠甘泉乐侶》冬季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_dvo_2013_winter_songs.json", JSON.stringify(audios, null, '\t'));
