...
var names = JSON.parse(fs.readFileSync('./daily_utmost_Dvo_2016_summer_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6390 * 1000000 + indexId + 1;
    audio.albumId = 6390;
    audio.albumName = "《竭诚为主》夏季合集";
    audio.albumtitle = "《竭诚为主》夏季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_utmost_dvo_2016_summer_songs.json", JSON.stringify(audios, null, '\t'));
