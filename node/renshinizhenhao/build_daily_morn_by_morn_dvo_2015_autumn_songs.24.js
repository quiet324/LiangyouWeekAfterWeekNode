...
var names = JSON.parse(fs.readFileSync('./daily_morn_by_morn_Dvo_2015_autumn_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6387 * 1000000 + indexId + 1;
    audio.albumId = 6387;
    audio.albumName = "《清晨甘露》秋季合集";
    audio.albumtitle = "《清晨甘露》秋季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_morn_by_morn_dvo_2015_autumn_songs.json", JSON.stringify(audios, null, '\t'));
