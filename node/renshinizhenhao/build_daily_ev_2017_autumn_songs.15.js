...
var names = JSON.parse(fs.readFileSync('./daily_ev_2017_autumn_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6375 * 1000000 + indexId + 1;
    audio.albumId = 6375;
    audio.albumName = "《靜夜亮光》秋季合集";
    audio.albumtitle = "《靜夜亮光》秋季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_ev_2017_autumn_songs.json", JSON.stringify(audios, null, '\t'));
