...
var names = JSON.parse(fs.readFileSync('./daily_ev_2017_summer_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6374 * 1000000 + indexId + 1;
    audio.albumId = 6374;
    audio.albumName = "《靜夜亮光》夏季合集";
    audio.albumtitle = "《靜夜亮光》夏季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_ev_2017_summer_songs.json", JSON.stringify(audios, null, '\t'));
