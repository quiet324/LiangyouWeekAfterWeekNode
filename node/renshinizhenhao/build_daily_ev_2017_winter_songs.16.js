...
var names = JSON.parse(fs.readFileSync('./daily_ev_2017_winter_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6376 * 1000000 + indexId + 1;
    audio.albumId = 6376;
    audio.albumName = "《靜夜亮光》冬季合集";
    audio.albumtitle = "《靜夜亮光》冬季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_ev_2017_winter_songs.json", JSON.stringify(audios, null, '\t'));
