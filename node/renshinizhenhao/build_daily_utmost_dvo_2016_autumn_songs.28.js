...
var names = JSON.parse(fs.readFileSync('./daily_utmost_Dvo_2016_autumn_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6391 * 1000000 + indexId + 1;
    audio.albumId = 6391;
    audio.albumName = "《竭诚为主》秋季合集";
    audio.albumtitle = "《竭诚为主》秋季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_utmost_dvo_2016_autumn_songs.json", JSON.stringify(audios, null, '\t'));
