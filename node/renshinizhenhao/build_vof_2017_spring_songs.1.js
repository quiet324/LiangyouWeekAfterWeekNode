...
names.forEach(function(name, indexId) {
    ...
    audio.id = 6349 * 1000000 + indexId + 1;
    audio.albumId = 6349;
    audio.albumName = "《认识你真好》2017年春季合集";
    audio.albumtitle = "《认识你真好》2017年春季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./vof_2017_spring_songs.json", JSON.stringify(audios, null, '\t'));
