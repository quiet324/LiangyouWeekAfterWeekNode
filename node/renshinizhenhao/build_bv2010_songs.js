...
var names = JSON.parse(fs.readFileSync('./bv2010_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    if (indexId < 90) {
        audio.id = 6188 * 1000000 + indexId + 1;
        audio.albumId = 6188;
        audio.albumName = "灵命日粮 2010年春季合集";
        audio.albumtitle = "灵命日粮 2010年春季合集" + "(" + (indexId + 1) + ")";
        audio.title = "灵命日粮-" + name.date;

        audios_spring.push(audio);

    } else if (indexId < (90 + 91)) {
        audio.id = 6189 * 1000000 + indexId + 1 - 90;
        audio.albumId = 6189;
        audio.albumName = "灵命日粮 2010年夏季合集";
        audio.albumtitle = "灵命日粮 2010年夏季合集" + "(" + (indexId + 1 - 90) + ")";
        audio.title = "灵命日粮-" + name.date;

        audios_summer.push(audio);

    } else if (indexId < (90 + 91 + 92)) {
        audio.id = 6190 * 1000000 + indexId + 1 - 90 - 91;
        audio.albumId = 6190;
        audio.albumName = "灵命日粮 2010年秋季合集";
        audio.albumtitle = "灵命日粮 2010年秋季合集" + "(" + (indexId + 1 - 90 - 91) + ")";
        audio.title = "灵命日粮-" + name.date;

        audios_autumn.push(audio);

    } else if (indexId < (90 + 91 + 92 + 92)) {
        audio.id = 6191 * 1000000 + indexId + 1 - 90 - 91 - 92;
        audio.albumId = 6191;
        audio.albumName = "灵命日粮 2010年冬季合集";
        audio.albumtitle = "灵命日粮 2010年冬季合集" + "(" + (indexId + 1 - 90 - 91 - 92) + ")";
        audio.title = "灵命日粮-" + name.date;
...
fs.writeFile("./lmrl_2010_spring.json", JSON.stringify(audios_spring, null, '\t'));
fs.writeFile("./lmrl_2010_summer.json", JSON.stringify(audios_summer, null, '\t'));
fs.writeFile("./lmrl_2010_autumn.json", JSON.stringify(audios_autumn, null, '\t'));
fs.writeFile("./lmrl_2010_winter.json", JSON.stringify(audios_winter, null, '\t'));
