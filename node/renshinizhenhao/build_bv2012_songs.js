...
var names = JSON.parse(fs.readFileSync('./bv2012_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    if (indexId < 91) {
        audio.id = 6196 * 1000000 + indexId + 1;
        audio.albumId = 6196;
        audio.albumName = "灵命日粮 2012年春季合集";
        audio.albumtitle = "灵命日粮 2012年春季合集" + "(" + (indexId + 1) + ")";
        audio.title = "灵命日粮-" + name.date;

        audios_spring.push(audio);

    } else if (indexId < (91 + 91)) {
        audio.id = 6197 * 1000000 + indexId + 1 - 91;
        audio.albumId = 6197;
        audio.albumName = "灵命日粮 2012年夏季合集";
        audio.albumtitle = "灵命日粮 2012年夏季合集" + "(" + (indexId + 1 - 91) + ")";
        audio.title = "灵命日粮-" + name.date;

        audios_summer.push(audio);

    } else if (indexId < (91 + 91 + 92)) {
        audio.id = 6198 * 1000000 + indexId + 1 - 91 - 91;
        audio.albumId = 6198;
        audio.albumName = "灵命日粮 2012年秋季合集";
        audio.albumtitle = "灵命日粮 2012年秋季合集" + "(" + (indexId + 1 - 91 - 91) + ")";
        audio.title = "灵命日粮-" + name.date;

        audios_autumn.push(audio);

    } else if (indexId < (91 + 91 + 92 + 92)) {
        audio.id = 6199 * 1000000 + indexId + 1 - 91 - 91 - 92;
        audio.albumId = 6199;
        audio.albumName = "灵命日粮 2012年冬季合集";
        audio.albumtitle = "灵命日粮 2012年冬季合集" + "(" + (indexId + 1 - 91 - 91 - 92) + ")";
        audio.title = "灵命日粮-" + name.date;
...
fs.writeFile("./lmrl_2012_spring.json", JSON.stringify(audios_spring, null, '\t'));
fs.writeFile("./lmrl_2012_summer.json", JSON.stringify(audios_summer, null, '\t'));
fs.writeFile("./lmrl_2012_autumn.json", JSON.stringify(audios_autumn, null, '\t'));
fs.writeFile("./lmrl_2012_winter.json", JSON.stringify(audios_winter, null, '\t'));
