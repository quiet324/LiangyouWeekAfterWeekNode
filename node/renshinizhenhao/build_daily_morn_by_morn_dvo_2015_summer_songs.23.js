...
var names = JSON.parse(fs.readFileSync('./daily_morn_by_morn_Dvo_2015_summer_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    ...
    audio.id = 6386 * 1000000 + indexId + 1;
    audio.albumId = 6386;
    audio.albumName = "《清晨甘露》夏季合集";
    audio.albumtitle = "《清晨甘露》夏季合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./daily_morn_by_morn_dvo_2015_summer_songs.json", JSON.stringify(audios, null, '\t'));
