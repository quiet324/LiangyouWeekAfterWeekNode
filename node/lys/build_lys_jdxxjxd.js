...
names.forEach(function(name, indexId) {
    ...
    if (indexId < 10) {
        audio.path = "https://rawcdn.githack.com/quiet324/LiangYouAlbums8/171114/lys_jdxxjxd/mavmt00" + (indexId + 1) + ".mp3";
    } else {
        audio.path = "https://rawcdn.githack.com/quiet324/LiangYouAlbums8/171114/lys_jdxxjxd/mavmt0" + (indexId + 1) + ".mp3";
    }
    audio.id = 6302 * 1000000 + indexId + 1;
    audio.albumId = 6302;
    audio.albumName = "《良院专区》近代神学家选读";
    audio.albumtitle = "《良院专区》近代神学家选读" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./lys_jdxxjxd_songs.json", JSON.stringify(audios, null, '\t'));
