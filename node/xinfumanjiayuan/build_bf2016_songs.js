...
var names = JSON.parse(fs.readFileSync('./bf2016_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 1760;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceBF2016/170713/bf2016" + '/' + name.name;
    audio.id = 5010 * 1000000 + indexId + 1;
    audio.albumId = 5010;
    audio.albumName = "《幸福满家园》2016 年合集";
    audio.albumtitle = "《幸福满家园》2016 年合集" + "(" + (indexId + 1) + ")";
    audio.title = "幸福满家园-" + name.date;
...
fs.writeFile("./bf2016_songs.json", JSON.stringify(audios, null, '\t'));
