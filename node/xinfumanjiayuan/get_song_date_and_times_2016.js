...
var dates = dates.filter(function(e) { return e !== '20160131'; });

var dates = dates.filter(function(e) { return e !== '20160214'; });

var dates = dates.filter(function(e) { return e !== '20160312'; });

var dates = dates.filter(function(e) { return e !== '20160925'; });

var dates = dates.filter(function(e) { return e !== '20161029'; });
...
var names = JSON.parse(fs.readFileSync('./bf2016_names.json', 'utf8'));
...
fs.writeFile("./bf2016_names_with_dates.json", JSON.stringify(name_and_dates, null, '\t'));
