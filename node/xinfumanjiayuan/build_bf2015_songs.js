...
var names = JSON.parse(fs.readFileSync('./bf2015_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 1760;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceBF2015/170713/bf2015" + '/' + name.name;
    audio.id = 5009 * 1000000 + indexId + 1;
    audio.albumId = 5009;
    audio.albumName = "《幸福满家园》2015 年合集";
    audio.albumtitle = "《幸福满家园》2015 年合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./bf2015_songs.json", JSON.stringify(audios, null, '\t'));
