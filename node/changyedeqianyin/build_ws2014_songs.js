...
var names = JSON.parse(fs.readFileSync('./ws2014_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 1760;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceWS2014/170714/ws2014" + '/' + name.name;
    audio.id = 5013 * 1000000 + indexId + 1;
    audio.albumId = 5013;
    audio.albumName = "《长夜的牵引》2014 年合集";
    audio.albumtitle = "《长夜的牵引》2014 年合集" + "(" + (indexId + 1) + ")";
    audio.title = "长夜的牵引-" + name.date;
...
fs.writeFile("./ws2014_songs.json", JSON.stringify(audios, null, '\t'));
