...
var names = JSON.parse(fs.readFileSync('./ws2015_names_with_dates.json', 'utf8'));
names.forEach(function(name, indexId) {
    var audio = {};
    audio.duration = 1760;
    audio.size = "6.9M";
    audio.path = "https://rawcdn.githack.com/quiet324/LiangYouResourceWS2015/170714/ws2015" + '/' + name.name;
    audio.id = 5014 * 1000000 + indexId + 1;
    audio.albumId = 5014;
    audio.albumName = "《长夜的牵引》2015 年合集";
    audio.albumtitle = "《长夜的牵引》2015 年合集" + "(" + (indexId + 1) + ")";
...
fs.writeFile("./ws2015_songs.json", JSON.stringify(audios, null, '\t'));
